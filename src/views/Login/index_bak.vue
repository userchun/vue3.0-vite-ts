      ...
      <div class="login-container">
        <div class="top">
          ...
          <div class="desc -enter-x">
            ...
            <span style="font-size: 0.1rem; color: black">
              21世纪创新人才!</span
            >
          </div>
        </div>
            ...
            <a-tab-pane key="2" tab="验证码登录" force-render>
              ...
              >
                <a-form-item name="phone">
                  <a-input
                    v-model:value="codeFormState.phone"
                    size="large"
                    placeholder=" 手机号"
                  >
                    <template #prefix
                ...
                <a-form-item name="code">
                  <a-input
                    v-model:value="codeFormState.code"
                    placeholder=" 验证码"
                    size="large"
...
export default defineComponent({
  ...
  setup() {
    ...
    const fn = { getCode, useEmailLogin, useCodeLogin, submit };
    const values = {
      emailFormState,
      codeFormState,
      rules,
